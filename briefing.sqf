...
3. Contracts and Contracting - PMC do not act as hitman, they are not allowed to keep targeting one person unless with a really good reason, for instance the Blufor Chief placing a Capture or Kill bounty on the Opfor Commanders head during war time. They may not accept contracts such as 'Kill all Cops' or 'Kill all Insurgents.' They may however take contracts such as clearing a checkpoint in order for an Illegal Weapon / Drug Shipment to get through. A list of acceptable contracts are as follows, use it as a general guideline.<br/>

Escort - Protecting Convoys etc.<br/>
Capture - Capturing and delivering a target to a client.<br/>
Kill - There must be direct text chat to prove a kill contract was created - Buyer needs to write in direct chat: I am paying PMC 500k to kill 'player'. Right after that, PMC needs to type in global chat, CONTRACT ACCEPTED(lack of proof can result in a ban or PMC blacklist)<br/>
...
2. War vehicles may not be used within cities, unless martial law or war is active. Otherwise, war vehicles may only be deployed on or near border checkpoints, and for patrol missions. <br/> 
...
5. You may not use war vehicles against civilians. <br/> 
