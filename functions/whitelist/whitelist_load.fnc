...
supporters1_list = [
	...
	"76561198165941900", //Power
	"76561198167164319", //Elijah
	"76561197970994550", //Staan
	"76561198040099429", //Supersahen
	"76561198145490697", //Dereck
...
supportersVIP_list = [
	...
	"76561198009886358", //Makorov
	"76561198044969338", //Joshua
	"76561198126593244", //Fakie
...
if (_uid in supporters1_list) then {
	supporters1 = true;
	["SERVER",[player,player,"supporters1",true],"s_whitelist_add",false,false]call network_MPExec;
	player sideChat "WhiteList Set S1";
};
if (_uid in supporters2_list) then {
	supporters2 = true;
	["SERVER",[player,player,"supporters2",true],"s_whitelist_add",false,false]call network_MPExec;
	player sideChat "WhiteList Set S2";
};
if (_uid in supporters3_list) then {
	supporters3 = true;
	["SERVER",[player,player,"supporters3",true],"s_whitelist_add",false,false]call network_MPExec;
	player sideChat "WhiteList Set S3";
};
if (_uid in supporters4_list) then {
	supporters4 = true;
	["SERVER",[player,player,"supporters4",true],"s_whitelist_add",false,false]call network_MPExec;
	player sideChat "WhiteList Set S4";
};
