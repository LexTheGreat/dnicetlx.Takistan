// Name:		Rotate_left.sqf
// Developer:	Tyler
// Date:		4/18/2012
// Usage:		Rotates the helicopter left a little bit, useful for player gunners and AI pilots
...
if (isNull _heli) then
{
	...
	{
		hint "Null returned to the Rotate_left.sqf Script";
	};
}
else
{
